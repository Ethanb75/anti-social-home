      ...
      <div className="hmeComponent">
          ...
          <div className="sexy__title">
            <div>
              ...
              <p>
                ...
                We help businesses with online marketing strategies from social media advertising to web optimization.
              </p>
              <div className="titleBtns">
                <button onClick={() => {
                    return document
                            .querySelector('.abt div:first-child')
                            .scrollIntoView({behavior: 'smooth'});
                  }}>Learn More</button>
                <button onClick={() => {
                    return document
                            .getElementsByClassName('cnt')[0]
                            .scrollIntoView({behavior: 'smooth'});
                  }}>Contact us</button>
              </div>
            </div>
          </div>
          <div className="world" title="Anti Social Marketing photo shoot">
            <img src={laptopPhone} style={{display: 'none'}} alt="Anti Social marketing rough location" />
          </div>
        </header>
        <section className="abt">
          ...
          <div className="abt__text">
            <h3>
              Build your digital brand using modern advertising services.
            </h3>
            <p>
        ...
        <section className="projects">
          <div className="projText">
            ...
            <span>
              <Link to="/projects" onClick={ev => this.linkClicked(ev, document.getElementById('projectsBtn'))}>see more <i className="fa fa-long-arrow-right" aria-hidden="true"></i></Link>
            </span>
          </div>
